...
class SosPageOne extends StatefulWidget {
  const SosPageOne({super.key});

  @override
  State<SosPageOne> createState() => _SosPageOneState();
}

class _SosPageOneState extends State<SosPageOne> {
  @override
