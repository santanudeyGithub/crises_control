...
class CustomerIdPage extends StatefulWidget {
  const CustomerIdPage({super.key});

  @override
  State<CustomerIdPage> createState() => _CustomerIdPageState();
}

class _CustomerIdPageState extends State<CustomerIdPage> {
